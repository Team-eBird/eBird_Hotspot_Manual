...
highlights differences between the suggested revisions and the page at the time the suggestion was made, NOT the current About page. This means if you Accept more recent pending suggestions, earlier pending suggestions may no longer apply (i.e., the text being changed may no longer exist on the page) We recommend quickly scanning the Details of all pending suggestions for a single hotspot before Accepting any of them.
